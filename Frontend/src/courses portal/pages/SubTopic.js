...
const SubTopic = () => {
    ...
    const [allTpoics , setAllTopics] = useState();
    ...
    useEffect(() => {
        const sendRequest = async () => {
            try{
                ...
                const response = await fetch(`http://localhost:5000/api/section/${subTopicId}`);
                ...
                setAllTopics(responseData.topics);
